...
validate_example() {
  ...
  temp_file=$(mktemp)
  java -jar input-cache/validator_cli.jar -version 4.0.1 -ig hl7.fhir.uv.smarthealthcards-vaccination $1 -profile http://hl7.org/fhir/uv/smarthealthcards-vaccination/StructureDefinition/$2 > $temp_file || true
