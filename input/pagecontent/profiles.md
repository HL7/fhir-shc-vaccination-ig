...
Bundles meant to populate the `fhirBundle` element of a SMART Health Card with a type of `https://smarthealth.cards#covid19` SHALL conform to one of the Bundles profiled in this IG. More specifically, bundles SHOULD conform to one of the Data Minimization Bundles and SHALL conform to one of the Allowable Data Bundles.
...
var ref = document.querySelector('h3:nth-of-type(1)');
