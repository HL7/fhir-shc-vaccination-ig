...
<div class="alert alert-danger">
  WARNING: Resources using AIR, ATC, GTIN, ICD-11, or GLN value sets will fail validation until their terminology servers are activated. If these value sets fail use CVX or SNOMED and MVX.
</div>
